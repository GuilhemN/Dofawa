 ...
 * WeaponTemplate
 *
 * @ORM\Entity(repositoryClass="Dof\ItemBundle\Entity\WeaponTemplateRepository")
 */
class WeaponTemplate extends SkinnedEquipmentTemplate
{
	 ...
	 * @var Collection
	 *
	 * @ORM\OneToMany(targetEntity="Dof\ItemBundle\Entity\WeaponDamageRow", mappedBy="weapon")
