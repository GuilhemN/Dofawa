...
class SessionControllerListener
{
    ...
    public function onKernelController(FilterControllerEvent $event)
    {
        ...
        if(!$this->re->getMethodAnnotation(new \ReflectionMethod($controller[0], $controller[1]), 'XN\Annotations\UsesSession') && !($controller[1] instanceof \Sonata\AdminBundle\Controller\CRUDController))
            $this->se->save();
    }
}
