...
class SessionControllerListener
{
    ...
    public function onKernelController(FilterControllerEvent $event)
    {
        ...
        $this->vb->setParameter('dof_user_last_username', (null === $session) ? '' : $session->get(SecurityContext::LAST_USERNAME));
        $this->vb->setParameter('dof_user_csrf_authenticate', $this->di->get('form.csrf_provider')->generateCsrfToken('authenticate'));
